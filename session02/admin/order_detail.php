...
<body>
    <main>
        ...
        <div>
            ...
            <a onclick="return confirm('Change status to Confirm?')" href="set_confirm_status.php?id=<?php echo $order["id"]; ?>"
            class="btn btn-primary">Confirm</a>
            <?php endif;?>
            <?php if($order["status"] == CONFIRM):?>
            <a  onclick="return confirm('Change status to Shipping?')" href="change_order_status.php?id=<?php echo $order["id"];?>"
            class="btn btn-secondary">Shipping</a>
            <?php endif;?>
            <?php if($order["status"] == SHIPPING):?>
            <a onclick="return confirm('Change status to Shipped?')" href="change_order_status.php?id=<?php echo $order["id"];?>"
            class="btn btn-info">Shipped</a>
            <?php endif;?>
            <?php if($order["status"] == SHIPPED):?>
            <a onclick="return confirm('Change status to Complete?')" href="change_order_status.php?id=<?php echo $order["id"];?>"
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="cancel_order.php?id=<?php echo $order["id"]; ?>">
            <button type="button" class="btn btn-danger">Cancel order</button> </a>
      </div>
    </div>
  </div>
</div>
